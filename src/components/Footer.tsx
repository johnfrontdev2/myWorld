        ...
        <div className="grid md:grid-cols-3 gap-12 items-start">
          ...
          <div className="md:col-span-1">
            ...
            >
              ...
              <div>
                <div className="text-xl font-display font-bold text-obsidian">
                  johnnightsteel
                </div>
                <div className="text-sm text-gunmetal font-medium">
                  Digital Architect
                </div>
              </div>
            </motion.div>
            ...
            <motion.div 
              className="text-sm text-gunmetal"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.6, delay: 0.2 }}
            >
              <p>Based globally.</p>
              <p>Building digitally.</p>
            </motion.div>
          </div>
          ...
          <div className="md:col-span-1">
            ...
            >
              <li>
                <a 
                  href="#services" 
                  className="text-gunmetal hover:text-midnight transition-colors duration-300 text-sm"
                >
                  Premium Websites
                </a>
              </li>
